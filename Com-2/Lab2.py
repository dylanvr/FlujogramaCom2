...
class Lab2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Programacion de sistemas en tiempo real", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Programacion de sistemas en tiempo real")
        ...
        self.frecuencia1 = frecuencia1 = 1000
        ...
        labels = ['MEDIA', 'MEDIA CUADRATICA', 'VALOR RMS', 'POTENCIA PROMEDIO', 'DESVIACION ESTANDAR',
            '', '', '', '', '']
        units = ['', '', '', '', '',
            '', '', '', '', '']
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frecuencia1, 1, 3, 0)
    ...
    def get_frecuencia1(self):
        return self.frecuencia1

    def set_frecuencia1(self, frecuencia1):
        self.frecuencia1 = frecuencia1
        self.analog_sig_source_x_0.set_frequency(self.frecuencia1)
