...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_vff([samp_rate/(N*samp_rate)]*N)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(2.)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/radiogis_director/Desktop/Com-2/LAB3/ComdigPractices2021sii-main/Fase I/Pract3/sonido.wav', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_1.set_k([self.samp_rate/(self.N*self.samp_rate)]*self.N)
